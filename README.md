...
/team - команда позволяющяя создавать свои команды. Использование: `/team создать <имя_команды>` - имя должно быть не более 70 символов и состоять только из букв и `_`;`/team пригласить в <имя_команды>` - ответе на сообщения того человека которого хотите пригласить в команду;
