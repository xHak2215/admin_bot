...
/to_text - перевод голосовых сообщений в текст (модель по умолчнию потерживает только Русский язык) используеться библиотека vosk<br>
